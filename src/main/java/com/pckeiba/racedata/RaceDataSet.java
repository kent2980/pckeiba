...
public class RaceDataSet extends RaceDataDefault{
	...
	private String tokubetsuTorokuBango;
	 ...
	 * @param winningHorse 勝ち馬
	 * @param tokubetsuTorokuBango 特別登録番号
	 */
	public RaceDataSet(String dataKubun, String raceCode, String kaisaiNenGappi, int kaisaiKaiji, int kaisaiNichiji,
			...
			String[] kakuTsukaJuni, int keibajoCode ,BigDecimal RPCI, BigDecimal ave3f, BigDecimal srunRow, BigDecimal srun55, String winningHorse, String tokubetsuTorokuBango) {
	...
	/**
	 * このレースの勝ち馬を返します
	 * @return winningHorse 勝ち馬
	 */
	public String getWinningHorse() {
		return winningHorse;
	}

	public String getTokubetsuTorokuBango() {
		return tokubetsuTorokuBango;
	}
